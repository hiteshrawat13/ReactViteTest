...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    <head>
        ...
        <script>
            new Image().src = "##pixelLink##<Base64 encrypted email>";
        </script>
                            ...
                            <tbody>
                                <tr style="background-color: white;">
                                    ...
                                    <td width="234" align="right">
                                        <div style="font-size: 14px; margin-top: 10px;">##sponsoredBy##</div>
                                        <img id="splogo" src="##baseUrl####logoName##" alt="Logo" style="##logoStyle##" />
                                    </td>
                ...
                <tr>
                    <td style="background: #fff; padding: 1.5% 2%;">
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <td width="100%" align="left" valign="top" style="" colspan="2">
                                ...
                                <tr>
                                    <td valign="top" align="left" style="padding-right: 2%;">
                                        <h1 style="font-size: 18px; color: #0066b2;" data-content="title">##landingTitle##</h1>
                                        <p style="font-size: 14px; color: #505050;" data-content="abstract">
                                            ##landingAbstract##
                                        </p>
                                    </td>
                                </tr>

...
const RolePopup = ({ roleData, setRoleData }) => {
    ...
    useEffect(() => {
        (async () => {
            const response1 = await axios.get(
                `${Config.API_BASE_URL}/user/getAllModules`
            );
    ...
    async function updatePermissions(e) {
        ...
        try {
            ...
            const response = await axios.post(`${Config.API_BASE_URL}/user/editRole`, { 'roleid': roleData.id, 'accessFormValue': accessFormValue2 });
    ...
    async function deleteRole() {
        ...
        try {
            ...
            const response = await axios.post(`${Config.API_BASE_URL}/user/deleteRole`, { 'roleid': roleData.id });
